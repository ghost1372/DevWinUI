...
internal partial class LoopingSelectorAutomationPeer : FrameworkElementAutomationPeer, ISelectionProvider, IScrollProvider
{
	private partial class PeerMap : Dictionary<DependencyObject, LoopingSelectorItemDataAutomationPeer>
	{
	}
