...
public partial class WindowedExtendedContentDialog
{
    ...
    public static readonly DependencyProperty HasTitleBarProperty =
        DependencyProperty.Register(nameof(HasTitleBar), typeof(bool), typeof(WindowedExtendedContentDialog), new PropertyMetadata(true, OnHasTitleBarChanged));

    private static void OnHasTitleBarChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        var ctl = (WindowedExtendedContentDialog)d;
    ...
    public static readonly DependencyProperty FlowDirectionProperty =
        DependencyProperty.Register(nameof(FlowDirection), typeof(FlowDirection), typeof(WindowedExtendedContentDialog), new PropertyMetadata(FlowDirection.LeftToRight, OnFlowDirectionChanged));
    ...
    public static readonly DependencyProperty CanResizeProperty =
        DependencyProperty.Register(nameof(CanResize), typeof(bool), typeof(WindowedExtendedContentDialog), new PropertyMetadata(true, OnCanResizeChanged));
    ...
    public static readonly DependencyProperty CanDragMoveWindowProperty =
        DependencyProperty.Register(nameof(CanDragMoveWindow), typeof(bool), typeof(WindowedExtendedContentDialog), new PropertyMetadata(false, OnCanDragMoveWindowChanged));
    ...
    public static readonly DependencyProperty MinWidthProperty =
        DependencyProperty.Register(nameof(MinWidth), typeof(double), typeof(WindowedExtendedContentDialog), new PropertyMetadata(0.0d, OnMinWidthChanged));
    ...
    public static readonly DependencyProperty MinHeightProperty =
        DependencyProperty.Register(nameof(MinHeight), typeof(double), typeof(WindowedExtendedContentDialog), new PropertyMetadata(double.NaN, OnMinHeightChanged));
