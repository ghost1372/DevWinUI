...
{
    public static void StartClipAnimation(this FrameworkElement element, CompositionClipAnimationDirection direction, float to,
    ...
    public static void StartClipAnimation(this Visual visual, CompositionClipAnimationDirection direction, float to,
        double duration = 800, int delay = 0, CompositionEasingFunction easing = null, Action completed = null,
        AnimationIterationBehavior iterationBehavior = AnimationIterationBehavior.Count)
    {
        CompositionScopedBatch batch = null;
    ...
    public static Task StartClipAnimationAsync(this FrameworkElement element, CompositionClipAnimationDirection direction, float to,
    ...
    public static Task StartClipAnimationAsync(this Visual visual, CompositionClipAnimationDirection direction, float to,
        double duration = 800, int delay = 0, CompositionEasingFunction easing = null,
        AnimationIterationBehavior iterationBehavior = AnimationIterationBehavior.Count)
    {
        CompositionScopedBatch batch;
