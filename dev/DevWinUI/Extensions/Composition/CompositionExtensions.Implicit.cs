...
{
	public static void EnableFluidVisibilityAnimation(this UIElement element, CompositionAnimationAxis? axis = null,
	...
	public static void EnableImplicitAnimation(this UIElement element, CompositionVisualPropertyType typeToAnimate,
	...
	public static void EnableImplicitAnimation(this Visual visual, CompositionVisualPropertyType typeToAnimate,
		double duration = 800, double delay = 0, CompositionEasingFunction easing = null)
	{
		var compositor = visual.Compositor;
	...
	private static KeyFrameAnimation CreateAnimationByType(Compositor compositor, CompositionVisualPropertyType type,
		double duration = 800, double delay = 0, CompositionEasingFunction easing = null)
	{
