...
{
    public static void StartTranslationAnimation(this UIElement element, CompositionAnimationAxis axis, float? from = null, float to = 0,
    ...
    public static Task StartTranslationAnimationAsync(this UIElement element, CompositionAnimationAxis axis, float? from = null, float to = 0,
