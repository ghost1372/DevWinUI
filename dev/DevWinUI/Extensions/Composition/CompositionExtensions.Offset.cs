...
{
    public static void StartOffsetAnimation(this UIElement element, CompositionAnimationAxis axis, float? from = null, float to = 0,
    ...
    public static void StartOffsetAnimation(this Visual visual, CompositionAnimationAxis axis, float? from = null, float to = 0,
        double duration = 800, int delay = 0, CompositionEasingFunction easing = null, Action completed = null,
        AnimationIterationBehavior iterationBehavior = AnimationIterationBehavior.Count)
    {
        CompositionScopedBatch batch = null;
    ...
    public static Task StartOffsetAnimationAsync(this UIElement element, CompositionAnimationAxis axis, float? from = null, float to = 0,
    ...
    public static Task StartOffsetAnimationAsync(this Visual visual, CompositionAnimationAxis axis, float? from = null, float to = 0,
        double duration = 800, int delay = 0, CompositionEasingFunction easing = null,
        AnimationIterationBehavior iterationBehavior = AnimationIterationBehavior.Count)
    {
        CompositionScopedBatch batch;
