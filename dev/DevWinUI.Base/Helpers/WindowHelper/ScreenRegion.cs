...
{
    private record Operation(ScreenRegion region, CombineMode mode);

    private class RectRegion : ScreenRegion
    {
    ...
    private class RectInt32Region : ScreenRegion
    {
    ...
    private class RoundRectRegion : ScreenRegion
    {
        private readonly Rect _rect;
    ...
    private class EllipticRegion : ScreenRegion
    {
    ...
    private class PolygonRegion : ScreenRegion
    {
    ...
    private class CurrentRegion : ScreenRegion
    {
    ...
    private class CombinedRegion : ScreenRegion
    {
        private readonly ScreenRegion _region1;
        private readonly ScreenRegion _region2;
        private readonly CombineMode _mode;
        public CombinedRegion(ScreenRegion region1, ScreenRegion region2, CombineMode mode)
        {
            _region1 = region1;
            _region2 = region2;
            _mode = mode;
    ...
    /// <returns></returns>
    public static ScreenRegion CreateRectangle(Rect rect) => new RectRegion(rect);
    ...
    /// <param name="rect">Rectangular region.</param>
    /// <returns></returns>
    public static ScreenRegion CreateRectangle(RectInt32 rect) => new RectInt32Region(rect);
    ...
    /// <returns></returns>
    public static ScreenRegion CreateRoundedRectangle(Rect rect, double w, double h) => new RoundRectRegion(rect, w, h);
    ...
    /// <returns></returns>
    public static ScreenRegion CreateElliptic(double x1, double y1, double x2, double y2) => new EllipticRegion(x1, y1, x2, y2);
    ...
    /// <returns></returns>
    public static ScreenRegion CreatePolygon(IEnumerable<Point> points) => new PolygonRegion(points, CREATE_POLYGON_RGN_MODE.ALTERNATE);
    ...
    public ScreenRegion Combine(ScreenRegion other, CombineMode mode) => new CombinedRegion(this, other, mode);
    ...
    /// <param name="b"></param>
    /// <returns></returns>
    public static ScreenRegion And(ScreenRegion a, ScreenRegion b) => a.Combine(b, CombineMode.And);
    ...
    /// <param name="b"></param>
    /// <returns></returns>
    public static ScreenRegion Xor(ScreenRegion a, ScreenRegion b) => a.Combine(b, CombineMode.Xor);
    ...
    /// <param name="b"></param>
    /// <returns></returns>
    public static ScreenRegion operator +(ScreenRegion a, ScreenRegion b) => a.Combine(b, CombineMode.Or);
    ...
    /// <returns></returns>
    public static ScreenRegion operator -(ScreenRegion region1, ScreenRegion region2) => region1.Combine(region2, CombineMode.Diff);
}

/// <summary>
/// A mode indicating how two regions will be combined. 
/// </summary>
/// <seealso cref="ScreenRegion.Combine(ScreenRegion, CombineMode)"/>
