...
public partial class SeventiesMeltRenderer : RendererBase
{
    private PixelShaderEffect<SeventiesMeltShader>? _effect;
    private float _timeAccumulator;

    public override void CreateResources(CanvasAnimatedControl sender, CanvasCreateResourcesEventArgs args)
    {
        Dispose();
        _effect = new PixelShaderEffect<SeventiesMeltShader>();
    }
    ...
    public override void Draw(ICanvasAnimatedControl sender, CanvasAnimatedDrawEventArgs args)
    {
        ...
        _effect.ConstantBuffer = new SeventiesMeltShader(
            _timeAccumulator,
