...
public partial class GradientFlowRenderer
{
    ...
    public static readonly DependencyProperty AccentColor1Property =
        DependencyProperty.Register(nameof(AccentColor1), typeof(Color), typeof(GradientFlowRenderer), new PropertyMetadata(ColorHelper.GetColorFromHex("#EAE2D3"), OnAccentColor1Changed));
    private static void OnAccentColor1Changed(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        var ctl = (GradientFlowRenderer)d;
    ...
    public static readonly DependencyProperty AccentColor2Property =
        DependencyProperty.Register(nameof(AccentColor2), typeof(Color), typeof(GradientFlowRenderer), new PropertyMetadata(ColorHelper.GetColorFromHex("#F34729"), OnAccentColor2Changed));
    ...
    public static readonly DependencyProperty AccentColor3Property =
        DependencyProperty.Register(nameof(AccentColor3), typeof(Color), typeof(GradientFlowRenderer), new PropertyMetadata(ColorHelper.GetColorFromHex("#1C1F47"), OnAccentColor3Changed));
    ...
    public static readonly DependencyProperty AccentColor4Property =
        DependencyProperty.Register(nameof(AccentColor4), typeof(Color), typeof(GradientFlowRenderer), new PropertyMetadata(ColorHelper.GetColorFromHex("#303380"), OnAccentColor4Changed));
