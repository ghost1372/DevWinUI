...
public partial class FireRenderer : RendererBase
{
    private PixelShaderEffect<FireShader>? _effect;
    private float _timeAccumulator;

    public override void CreateResources(CanvasAnimatedControl sender, CanvasCreateResourcesEventArgs args)
    {
        Dispose();
        _effect = new PixelShaderEffect<FireShader>();
    }
    ...
    public override void Draw(ICanvasAnimatedControl sender, CanvasAnimatedDrawEventArgs args)
    {
        ...
        _effect.ConstantBuffer = new FireShader(
            _timeAccumulator,
