...
public partial class LoopingSelector
{
    ...
    public LoopingSelector()
    {
        ...
        Resources.MergedDictionaries.AddIfNotExists(new LoopingSelectorItemTemplate());
        ItemTemplate = Resources["LoopingSelectorItemDefaultTemplate"] as DataTemplate;
    }
        ...
        ScrollViewerViewChangedEventArgs pEventArgs)
    {
        ...
        DispatcherQueue.TryEnqueue(ProcessEvent);
    }
        ...
        PointerRoutedEventArgs pEventArgs)
    {
        ...
        nPointerDeviceType = pEventArgs.Pointer.PointerDeviceType;
        ...
        TappedRoutedEventArgs pArgs)
    {
        if (_itemState == ItemState.Expanded)
        {
            LoopingListSelectorInfo spLsiInterface;
            //pSender.QueryInterface<LoopingSelectorItem>(spLsiInterface);
            spLsiInterface = pSender as LoopingListSelectorInfo;
    ...
    {
        LoopingListSelectorInfo spChildAsLSI;
    ...
    {
        LoopingListSelectorInfo spChild;
    ...
    void UpdateVisualSelectedItem(uint oldIdx, uint newIdx)
    {
        ...
        LoopingListSelectorInfo spEltAsLSI;
        LoopingListSelectorInfo lsi = null;
        ...
        if (realizedItemsCount > 0)
        {
            if (realizedItemsCount > oldIdx - _realizedTopIdx)
            {
                ...
                if (_itemState == ItemState.Expanded)
                {
                    lsi.SetState(LoopingListSelectorInfo.State.Expanded, true);
                }
                else
                {
                    lsi.SetState(LoopingListSelectorInfo.State.Normal, true);
                }
            }
            ...
            if (realizedItemsCount > newIdx - _realizedTopIdx)
            {
                ...
                lsi = spEltAsLSI;
                lsi.SetState(LoopingListSelectorInfo.State.Selected, true);
            }
        }
    }
    ...
    void RealizeItem(uint itemIdxToRealize, out LoopingListSelectorInfo ppItem)
    {
        LoopingListSelectorInfo spLoopingSelectorItem;
        ...
        if (!(spLoopingSelectorItem is { }))
        {
            ...
            spLoopingSelectorItem = new LoopingListSelectorInfo();
        ...
        if (_itemState == ItemState.Expanded || _itemState == ItemState.ManipulationInProgress ||
            _itemState == ItemState.LostFocus)
        {
            lsi.SetState(LoopingListSelectorInfo.State.Expanded, false);
        }
        else
        {
            lsi.SetState(LoopingListSelectorInfo.State.Normal, false);
        }
    ...
    void RecycleItem(LoopingListSelectorInfo pItem)
    {
        LoopingListSelectorInfo spItemAsLSI;
    ...
    protected override void OnApplyTemplate()
    {
        ...
        if (spUpButtonAsDO is Microsoft.UI.Xaml.Controls.Primitives.ButtonBase spUpButtonAsButtonBase)
        {
        ...
        if (spDownButtonAsDO is Microsoft.UI.Xaml.Controls.Primitives.ButtonBase spDownButtonAsButtonBase)
        {
        ...
        if (spScrollViewerAsDO is { })
        {
            ...
            _tpScrollViewer.HorizontalSnapPointsType = SnapPointsType.None;
            _tpScrollViewerPrivate.HorizontalSnapPointsType = SnapPointsType.None;
        }
    ...
    void SetScrollPosition(double offset, bool useAnimation)
    {
        ...
        if (!useAnimation)
        {
            ...
            didSucceed = _tpScrollViewer.ChangeView(
        ...
        else
        {
            ...
            {
                _tpScrollViewer.ChangeView(null, spVerticalOffset, null,
    ...
    internal void AutomationGetSelectedItem(out LoopingListSelectorInfo ppItemNoRef)
    {
        ppItemNoRef = null;
    ...
    void RetreiveItemFromAPRealizedItems(uint moddeItemdIdx, out LoopingListSelectorInfo ppItem)
    {
        ppItem = null;
    ...
    internal void AutomationTryGetSelectionUIAPeer(out AutomationPeer ppPeer)
    {
        ...
        LoopingListSelectorInfo pLSINoRef = null;
    ...
    {
        ppPeer = null;
        LoopingListSelectorInfo spChild = default;
    ...
    {
        LoopingListSelectorInfo spItem;
