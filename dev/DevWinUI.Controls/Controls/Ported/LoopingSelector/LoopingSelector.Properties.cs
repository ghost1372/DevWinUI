...
public partial class LoopingSelector
{
	...
	public static DependencyProperty ItemsProperty { get; } =
		DependencyProperty.Register(
			...
			typeof(LoopingSelector),
			new PropertyMetadata(default(IList<object>), propertyChangedCallback: (sender, args) => ((LoopingSelector)sender).OnPropertyChanged(args)));
	...
	public static DependencyProperty SelectedIndexProperty { get; } =
		DependencyProperty.Register(
			...
			typeof(LoopingSelector),
			new PropertyMetadata(default(int), propertyChangedCallback: (sender, args) => ((LoopingSelector)sender).OnPropertyChanged(args)));
	...
	public static DependencyProperty ShouldLoopProperty { get; } =
		DependencyProperty.Register(
			...
			typeof(LoopingSelector),
			new PropertyMetadata(default(bool), propertyChangedCallback: (sender, args) => ((LoopingSelector)sender).OnPropertyChanged(args)));
}
