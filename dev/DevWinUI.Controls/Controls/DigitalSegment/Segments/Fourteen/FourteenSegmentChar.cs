...
public sealed partial class FourteenSegmentChar : SegmentChar
{
    protected override IReadOnlyDictionary<string, string> PatternTable => StandardFourteenSegmentPattern.Patterns;
    protected override string DefaultPattern => StandardFourteenSegmentPattern.DefaultPattern;

    public FourteenSegmentChar()
    {
        DefaultStyleKey = typeof(FourteenSegmentChar);
    }
    ...
    protected override void CollectSegments()
    {
        Segments = new()
        {
            ("A", GetTemplateChild("PART_SegmentA") as Path),
            ("B",  GetTemplateChild("PART_SegmentB") as Path),
            ("C", GetTemplateChild("PART_SegmentC") as Path),
            ("D", GetTemplateChild("PART_SegmentD") as Path),
    ...
    {
        return new FourteenSegmentChar();
    }
}
